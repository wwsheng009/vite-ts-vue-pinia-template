...
参考：https://juejin.cn/post/7079785777692934174

pnpm create vite 模板生成的package.json中的type字段需要删除
...
-   [仓库地址](https://github.com/jeddygong/vite-templates/tree/master/vite-vue3-ts-pinia)
...
由于 ESLint 默认使用 [Espree](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Feslint%2Fespree "https://github.com/eslint/espree") 进行语法解析，无法识别 TypeScript 的一些语法，故我们需要安装 [`@typescript-eslint/parser`](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Ftypescript-eslint%2Ftypescript-eslint%2Ftree%2Fmaster%2Fpackages%2Fparser "https://github.com/typescript-eslint/typescript-eslint/tree/master/packages/parser") 替代掉默认的解析器

```
pnpm install @typescript-eslint/parser --save-dev
```

安装对应的插件 [@typescript-eslint/eslint-plugin](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Ftypescript-eslint%2Ftypescript-eslint%2Ftree%2Fmaster%2Fpackages%2Feslint-plugin "https://github.com/typescript-eslint/typescript-eslint/tree/master/packages/eslint-plugin") 它作为 eslint 默认规则的补充，提供了一些额外的适用于 ts 语法的规则。
...
> 更详细上手指南：[链接](https://juejin.cn/post/7049196967770980389 "https://juejin.cn/post/7049196967770980389") 官方文档：[链接](https://link.juejin.cn/?target=https%3A%2F%2Fpinia.vuejs.org%2Fintroduction.html "https://pinia.vuejs.org/introduction.html")
...
更多函数官方文档：[链接](https://link.juejin.cn/?target=https%3A%2F%2Fvueuse.org%2F "https://vueuse.org/")

## 6\. CSS 的集成

## 方案一：原生 css variable 新特性：

原生支持，不需要第三方插件，具体使用文档可 [查看](https://link.juejin.cn/?target=https%3A%2F%2Fdeveloper.mozilla.org%2Fzh-CN%2Fdocs%2FWeb%2FCSS%2Fvar "https://developer.mozilla.org/zh-CN/docs/Web/CSS/var")
...
注：还可以增加 PostCSS 配置，(任何受 [postcss-load-config](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fpostcss%2Fpostcss-load-config "https://github.com/postcss/postcss-load-config") 支持的格式，例如 `postcss.config.js` )，它将会自动应用于所有已导入的 CSS。
...
3.  亦或者使用 [unplugin-vue-components](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fantfu%2Funplugin-vue-components "https://github.com/antfu/unplugin-vue-components") 来进行按需加载 vue 组件

## 9\. 使用 [commitizen](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fcommitizen%2Fcz-cli "https://github.com/commitizen/cz-cli") 规范git提交
...
> 
> 如果想用最新版的 husky，建议[参考官网](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Ftypicode%2Fhusky "https://github.com/typicode/husky")去配置
